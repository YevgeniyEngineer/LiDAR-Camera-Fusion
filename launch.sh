...
ros2 run sensor_data_publisher_node sensor_data_publisher_node \
    --ros-args --params-file "${SCRIPT_DIR}/sensor_data_publisher_node/config/sensor_data_publisher_node.param.yaml"
