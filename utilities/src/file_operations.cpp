                                   ...
                                   std::vector<data_types::CartesianReturn> &point_cloud)
{
    ...
    const std::size_t number_of_points = file_size / sizeof(data_types::CartesianReturn);

    if (file_size % sizeof(data_types::CartesianReturn) != 0)
    {
    ...
    input_file.read(reinterpret_cast<char *>(point_cloud.data()),
                    number_of_points * sizeof(data_types::CartesianReturn));
